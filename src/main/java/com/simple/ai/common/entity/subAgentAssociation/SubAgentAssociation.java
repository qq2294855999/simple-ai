package com.simple.ai.common.entity.subAgentAssociation;
...
/**
 * 子智能体关联(sub_agent_association)实体类
...
@TableName(value = "sub_agent_association", autoResultMap = true)
@Schema(title = "子智能体关联(sub_agent_association)实体类")
public class SubAgentAssociation {
     ...
     * 主智能体
     */
    @TableField(value = "main_agent")
    private String mainAgent;

    /**
     * 子智能体
     */
    @TableField(value = "sub_agent")
