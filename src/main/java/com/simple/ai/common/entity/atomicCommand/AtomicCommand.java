package com.simple.ai.common.entity.atomicCommand;
...
@TableName(value = "atomic_command", autoResultMap = true)
@Schema(title = "原子命令(atomic_command)实体类")
