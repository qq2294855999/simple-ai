package com.simple.ai.common.entity.subAgentRelation;
...
@TableName(value = "sub_agent_relation", autoResultMap = true)
@Schema(title = "子智能体关联(sub_agent_relation)实体类")
public class SubAgentRelation {
     ...
     * 主智能体
     */
    @TableField(value = "main_agent_id")
    private String mainAgentId;

    /**
     * 子智能体
     */
    @TableField(value = "sub_agent_id")
